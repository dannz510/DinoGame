...
export const player = (() => {
  ...
  class Player {
    ...
    InitInput_() {
      ...
      // Add touch event listener for jumping
      document.addEventListener('touchstart', (e) => this.OnTouchStart_(e), false);
      document.addEventListener('touchend', (e) => this.OnTouchEnd_(e), false);
    }
    ...
    Update(timeElapsed) {
      // Check if spacebar is pressed OR a touch is active
